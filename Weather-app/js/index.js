...
btn.addEventListener("click",()=>{
    ...
    var geocodingapi="http://api.openweathermap.org/geo/1.0/direct?q="+city+"&appid={API Key}";
    ...
    function latlondata(data)
    {
        ...
        url="https://api.openweathermap.org/data/2.5/weather?lat="+data[0].lat+"&lon="+data[0].lon+"&appid={API Key}&units=metric";
        fetch(url)
        .then((response)=>{
